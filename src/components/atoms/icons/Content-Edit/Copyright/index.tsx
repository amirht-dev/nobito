...
export const Copyright_Outline = forwardRef<SVGSVGElement, SVGIconProps>(
...
Copyright_Outline.displayName = "Copyright_Outline";

const Copyright = { Outline: Copyright_Outline };
