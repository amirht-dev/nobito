...
export const Edit2_Outline = forwardRef<SVGSVGElement, SVGIconProps>(
  ({ fillPath = "currentColor", ...props }, ref) => {
    return (
      ...
      >
        ...
        />
        <path
          d="M17.34 10.95C17.32 10.95 17.29 10.95 17.27 10.95C14.15 10.64 11.64 8.26997 11.16 5.16997C11.1 4.75997 11.38 4.37997 11.79 4.30997C12.2 4.24997 12.58 4.52997 12.65 4.93997C13.03 7.35997 14.99 9.21997 17.43 9.45997C17.84 9.49997 18.14 9.86997 18.1 10.28C18.05 10.66 17.72 10.95 17.34 10.95Z"
          fill={fillPath}
        />
        <path
...
Edit2_Outline.displayName = "Edit2_Outline";

const Edit2 = { Outline: Edit2_Outline };
