...
export const Instagram_Outline = forwardRef<
  SVGSVGElement,
  SVGIconProps<"#292D32">
...
Instagram_Outline.displayName = "BootstrapOutline";

export const Instagram_bold = forwardRef<SVGSVGElement, SVGIconProps>(
  ({ fillPath = "currentColor", ...props }, ref) => {
    return (
      <svg
        width="24"
...
Instagram_bold.displayName = "InstagramBold";

const Instagram = { Outline: Instagram_Outline, bold: Instagram_bold };
