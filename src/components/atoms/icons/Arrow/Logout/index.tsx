...
export const Logout_Outline = forwardRef<
  SVGSVGElement,
  SVGIconProps<"#292D32">
...
Logout_Outline.displayName = "Logout_Outline";

export const Logout_Bold = forwardRef<SVGSVGElement, SVGIconProps<"#292D32">>(
  ({ fillPath = "currentColor", ...props }, ref) => {
    return (
      <svg
        width="24"
...
Logout_Bold.displayName = "Logout_Bold";

const Logout = { Logout_Outline, Logout_Bold };
