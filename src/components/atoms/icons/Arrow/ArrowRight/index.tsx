...
export const ArrowRight_Outline = forwardRef<SVGSVGElement, SVGIconProps>(
...
ArrowRight_Outline.displayName = "ArrowRight_Outline";

const ArrowRight = { Outline: ArrowRight_Outline };
