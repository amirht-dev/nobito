...
export const ChevronLeft_Outline = forwardRef<SVGSVGElement, SVGIconProps>(
...
ChevronLeft_Outline.displayName = "ChevronLeft_Outline";

const ChevronLeft = { Outline: ChevronLeft_Outline };
